 ...
 */
class restore_qtype_kekule_chem_multi_plugin extends restore_qtype_kekule_chem_base_plugin
{
    ...
    {
        return 'kekule_chem_multi';  // we used get_recommended_name() so this works
    }

    public function process_kekule_chem_multi($data) {
